...
<!-- SECTION HEADLINE -->
	<div class="section-headline-wrap">
		<div class="section-headline">
			<h2>{{ \App\Users::username($vendor->id) }}</h2>
			<p>Home<span class="separator">/</span><span class="current-section">{{ $vendor->user_slug }}</span></p>
		</div>
	</div>
	<!-- /SECTION HEADLINE -->
		...
		<div class="section">
			<div class="content">
				...
				<div class="product-showcase">
					...
					@foreach(\App\Products::where('prod_vendor_id',$vendor->id)->get() as $product)	
