        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    Services &nbsp;<img src="{{ asset('home_asset/fonts/Shape1.png')}}"/>&nbsp; {{ $name }}
                    </span>
                                    ...
                                    <div class="blog-item">
                                        <div class="ih-item square effect13 left_to_right">
                                            <a href="{{ URL::to('service') }}/{{ $product->prod_slug }}/{{ $product->id }}">
                                              ...
                                              <div class="info">
                            					  <div class="col-md-6 col-xs-6"><span class="off1"><a href="{{ URL::to('service') }}/{{ $product->prod_slug }}/{{ $product->id }}">View</a></span></div>
                                                    <div class="col-md-6 col-xs-6"><span class="off2"><a href="{{ URL::to('serviceorder') }}/{{ $product->id }}">Buy Now</a></span></div>
                                                  </div>
