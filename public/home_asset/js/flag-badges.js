...
(function($){
	var flags = [
		...
		{ name:'Bosnia and Herzegovina', src: 'bos' },
		...
		{ name:'Central African Republic', src: 'car' },
		{ name:'Chad', src: 'cha' },
		{ name:'Chile', src: 'chi' },
		{ name:'China', src: 'chn' },
		{ name:'Colombia', src: 'col' },
		{ name:'Comoros', src: 'com' },
		{ name:'Dem. Republic of the Congo', src: 'drc' },
		{ name:'Congo', src: 'cgo' },
		...
		{ name:'Nagorno-Karabakh Rep.', src: 'nak' },
		...
		{ name:'Russia', src: 'rus' },
		{ name:'Rwanda', src: 'rwa' },
		{ name:'Sahrawi Arab Dem. Rep.', src: 'sah' },
		{ name:'Saint Kitts and Nevis', src: 'skn' },
		{ name:'Saint Lucia', src: 'slu' },
		{ name:'St. Vincent and the Grenadines', src: 'svg' },
		{ name:'Samoa', src: 'sam' },
		{ name:'San Marino', src: 'sma' },
		{ name:'Sao Tomé and Príncipe', src: 'stp' },
